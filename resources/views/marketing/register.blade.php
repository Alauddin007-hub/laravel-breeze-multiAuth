                ...
                <div class="card border-3">
                    <div class="card-body p-5">
                        ...
                        <div class="form-body mt-4">
                            <form class="row g-3" method="post" action="{{route('marketing_store.store')}}">
                                @csrf
                                <div class="col-12">
                                    <label for="inputUsername" class="form-label">Username</label>
                                    <input type="text" class="form-control" name="name" id="inputUsername" placeholder="Jhon">
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group" id="show_hide_password">
                                        <input type="password" name="password_confirmation" class="form-control border-end-0" id="inputChooseConfirmPassword" placeholder="Enter Confirm Password">
                                        <a href="javascript:;" class="input-group-text bg-transparent"><i class="bi bi-eye-slash-fill"></i></a>
                                    </div>
                                </div>
